...
namespace UblLarsen.Test
{
    ...
    public class UblDocLoadTest
    {
        ...
        public void ReadCreditNote()
        {
            ...
            Assert.AreEqual("IYT Corporation", doc.AccountingCustomerParty.Party.PartyName[0].Name.Value);
        ...
        public void ReadInvoice()
        {
            ...
            string name = doc.AccountingCustomerParty.Party.PartyName[0].Name.Value;
            Assert.AreEqual(name, "IYT Corporation");

            doc.Delivery[0].ActualDeliveryTime.Value = DateTime.SpecifyKind(doc.Delivery[0].ActualDeliveryTime.Value, DateTimeKind.Utc);
        ...
        public void ReadForwardingInstructionInternational()
        {
            ...
            Assert.AreEqual("Mr Fred Churchill", doc.Shipment.Consignment.ConsigneeParty.Contact.Name.Value);
        ...
        public void ReadReceiptAdvice()
        {
            ...
            Assert.AreEqual("Heremouthshire", doc.DespatchSupplierParty.Party.PostalAddress.CountrySubentity.Value);
        ...
        public void ReadRemittanceAdvice()
        {
            ...
            Assert.AreEqual("849FBBCE-E081-40B4-906C-94C5FF9D1AC3", doc.RemittanceAdviceLine[0].BillingReference[0].InvoiceDocumentReference.UUID.Value);
        ...
        /// Test are slower with XmlNamespaceDeclarations on base document
        /// Time writing 1000 invoices to memory: 0:00:00:00,8719844 (Xeon E3-1225@3.1GHz)
        /// </summary>
        [TestMethod]
        public void Write1000InvoicesToMem()
        {
            ...
            for (int i = 0; i < count; i++)
            {
                InvoiceType doc = docs[i % 2];
                UblDoc<InvoiceType>.Save(buffer[i], doc);
                // Touch invoice. Add one day to issuedate
                doc.IssueDate.Value += TimeSpan.FromDays(1);
            }
            stopWatch.Stop();
